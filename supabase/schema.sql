...
ALTER TABLE public.drivers ADD COLUMN IF NOT EXISTS amenities TEXT[];
ALTER TABLE public.drivers ADD COLUMN IF NOT EXISTS bio TEXT;
ALTER TABLE public.drivers ADD COLUMN IF NOT EXISTS vehicle_category TEXT DEFAULT 'classico';
